metadata {
  definition (name: "CT100 Thermostat (custom)", namespace: "motley74", author: "Michael Hudson") {
    capability "Actuator"
  ...
  tiles(scale: 2) {
    ...
    standardTile("mode", "device.thermostatMode", width: 3, height: 3, inactiveLabel: false, canChangeIcon: true) {
	...
	standardTile("fanMode", "device.thermostatFanMode", width: 3, height: 3, inactiveLabel: false, canChangeIcon: true) {
		state "fanAuto", label:"Fan\nAuto", action:"switchFanMode", icon: "st.Appliances.appliances11"
		state "fanOn", label:"Fan\nOn", action:"switchFanMode", icon: "st.Appliances.appliances11", backgroundColor: '#02E181'
		state "fanCirculate", label:"Fan\nCirculate", action:"switchFanMode", icon: "st.Appliances.appliances11", backgroundColor: '#02D2E1'
	}
	...
	main "temperature"
	details(["temperature", "mode", "fanMode", "heatingSetpoint", "heatSliderControl", "heatLevelUp", "heatLevelDown", "coolingSetpoint", "coolSliderControl", "coolLevelUp", "coolLevelDown", "humidity", "battery", "refresh"])
  }
}
